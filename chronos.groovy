...
create_scheduled_job(http, [name: "state_store-classification1_exprJob", 
                            command: """/home/spiderdt/work/git/spiderdt-release/groovy/expr_job.groovy state_store-classification1_exprJob
{"classId":"classification1","data_sources":{"d_bolome_dau":{"driven_items":[{"data_type":"string","data_item":"num"},{"data_type":"string","data_item":"lalalala","expr":":date > 4 || :dau <= 6 "},{"data_type":"string","data_item":"dau"}],"target_items":[{"data_type":"string","data_item":"numLim","expr":":num > 9 || :num <= 15 "}]}}}
                            """, 
                            description: "create time:20161011_1851",
                            owner: "269243757@qq.com",
                            retries: 2,
                            async: false,
                            schedule: "R//PT2H"])
