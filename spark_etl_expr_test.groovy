...
/* model.d_bolome_orders
def tabs_str = """["model.d_bolome_orders", "4ml.R.d_bolome_orders"]"""
...
*/
/* model.d_bolome_product_category
def tabs_str = """["model.d_bolome_product_category", "4ml.R.d_bolome_product_category"]"""
def tab_cols_str = """["'barcode", "'product_name", "'category_1", "'category_2"] """
*/
/* model.d_bolome_shows
def tabs_str = """["model.d_bolome_shows", "4ml.R.d_bolome_shows"]"""
def tab_cols_str = """["'show_id", "'show_name", "'begin_time_ts", "'end_time_ts"] """
*/
/* model.d_bolome_events
*/
def tabs_str = """["model.d_bolome_events", "4ml.R.d_bolome_events"]"""
def tab_cols_str = """["'prt_path", "'event_id", "'type_name", "'event_name", "'create_date_dt"] """
